...
mod ERC721 {
    ...
    impl ERC721Impl of interface::IERC721<ContractState> {
        ...
        fn approve(ref self: ContractState, to: ContractAddress, token_id: u256) {
            ...
            assert(
                owner == caller || ERC721Impl::is_approved_for_all(@self, owner, caller), 'ERC721: unauthorized caller'
            );
    ...
    #[generate_trait]
    impl InternalStateAccess of InternalStateAccessTrait {
        fn initializer(ref self: ContractState, name_: felt252, symbol_: felt252) {
            self._name.write(name_);
            self._symbol.write(symbol_);

            let mut unsafe_state = src5::SRC5::unsafe_new_contract_state();
            src5::SRC5::RegisterImpl::register_interface(ref unsafe_state, interface::IERC721_ID);
            src5::SRC5::RegisterImpl::register_interface(
        ...
        fn _is_approved_or_owner(self: @ContractState, spender: ContractAddress, token_id: u256) -> bool {
            ...
            owner == spender || is_approved_for_all || spender == ERC721Impl::get_approved(self, token_id)
        }
        ...
        fn _safe_transfer(ref self: ContractState, 
